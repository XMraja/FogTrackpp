...
class TestDataset(Dataset):
    ...
    def __init__(self, data_root, split, seq_name, img_size=[640, 640], legacy_yolox=False, model='yolox', **kwargs) -> None:
        """
        Args:
        ...
        self.seq_path = osp.join(self.data_root,  self.split, self.seq_name, "img1")

        # SDM
        # self.seq_path = osp.join(self.data_root,  self.split, self.seq_name, "images")
...
class DemoDataset(TestDataset):
    ...
    dataset for demo
    """
    def __init__(self, file_name, img_size=[640, 640], model='yolox', legacy_yolox=False, **kwargs) -> None:
